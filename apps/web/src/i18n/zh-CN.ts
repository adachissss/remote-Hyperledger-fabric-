...
const apiErrorMessages: Record<string, string> = {
  ...
  invalid_managed_network: '网络拓扑配置不正确，请检查组织、通道和端口设置。',
  managed_workspace_exists: '该网络的托管工作区已经存在，请更换网络 ID。',
  managed_workspace_generation_failed: '无法生成网络工作区，请检查运行目录权限。',
  managed_driver_template_unavailable: 'Fabric 脚本模板或本地工具不可用。',
  managed_config_generation_failed: '生成的 Fabric 网络配置无法解析。',
  managed_port_conflict: '计划使用的宿主机端口已被占用，请改用自动分配或其他起始端口。',
  managed_port_range_unavailable: '当前没有足够的连续宿主机端口可供该拓扑使用。',
  managed_docker_network_conflict: '计划使用的 Docker 网络名称已经存在。',
  managed_container_name_conflict: '计划使用的容器名称已经存在。',
  managed_namespace_conflict: '该网络的 Docker 或 Compose 命名空间已经注册。',
  managed_docker_unavailable: 'Docker 当前不可用，无法检查网络和容器命名冲突。',
  network_namespace_conflict: '该 Docker 网络或 Compose 项目已被其他网络使用。',
  network_port_conflict: '该网络发布的宿主机端口已被其他网络注册。',
